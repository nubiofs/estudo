...
public class MongoDBItemWriter implements ItemWriter<Object>, InitializingBean, ChunkListener {
	...
	public MongoDBItemWriter(String db_name, String collection_name) {
		super();
		this.db = db_name;
	...
	private DBObject convert(Object o) {
		...
		doc.put("km", car.getKm());
		doc.put("nome", car.getNome());
...
//		if ( checkWriteResult &&  wr != null && wr.getN() == 0) {
//			throw new MongoDBInsertFailedException(databaseName, collectionName, "Erro na inserção");
//		}
