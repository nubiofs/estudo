...
@Component
public class JobCarroToSqlCompletionNotificationListener extends JobExecutionListenerSupport {

	private static final Logger log = LoggerFactory.getLogger(JobCarroToSqlCompletionNotificationListener.class);

	private final JdbcTemplate jdbcTemplate;

	@Autowired
	public JobCarroToSqlCompletionNotificationListener(JdbcTemplate jdbcTemplate) {
