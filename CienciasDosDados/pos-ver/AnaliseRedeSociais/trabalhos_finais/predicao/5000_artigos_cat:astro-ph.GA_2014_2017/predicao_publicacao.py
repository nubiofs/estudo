...
def obter_autores_artigos_from_arxiv(from_arxiv):
    ...
    if from_arxiv:
        ...
        df_autor_artigos_2017.to_csv(
            'registros_autores_artigos_2017_cat:astro-ph.GA.csv',
            columns=['author', 'id', 'title', 'summary', 'published_year'], 
            encoding='utf-8', index=False, sep='@')
    ...
    return df_autor_artigos_2014, df_autor_artigos_2017 
...
df_2014, df_2017 = obter_autores_artigos_from_arxiv(True)
#df_2014, df_2017 = obter_autores_artigos_from_arxiv(False)
...
# ser preditos em 2014 (ou seja, que podem ou não publicar em conjunto no ano de 2017).
...
#
lista_autores_predicao_em_2014_para_2017 = []
        ...
        for n2 in grafo_2014.neighbors(n1):
            ...
            for n3 in grafo_2014.neighbors(n2):
                ...
                if grafo_2017.has_node(n3): 
                    ...
                    if (nx.shortest_path_length(grafo_2014, source=n1, target=n3) == 2) and (not [n1, n3] in lista_autores_predicao_em_2014_para_2017):
                        lista_autores_predicao_em_2014_para_2017.append([n1, n3]) #Uma lista de listas
...
# tiverem publicado nos dois anos seguidos (2014 e 2017) e tiverem calculo de 
# coeficiente predição suficiente:
#
for n1, n2 in lista_autores_predicao_em_2014_para_2017:
