...
{console.log(data);if(data.succ)
{$("#captchaModal").foundation('reveal','close');e.preventDefault();var param=data.email;var type=data.type;var confirm=$("#captchaConfirmEmailModal");confirm.load("/email/captcha_confirmation?email="+param+"&type="+type,function(data)
