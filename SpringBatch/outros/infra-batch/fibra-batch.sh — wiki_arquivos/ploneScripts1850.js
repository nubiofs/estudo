...
// https://wiki.serpro/portal_javascripts/event-registration.js?original=1
...
// https://wiki.serpro/portal_javascripts/register_function.js?original=1
...
/* - cssQuery.js - */
// https://wiki.serpro/portal_javascripts/cssQuery.js?original=1
...
/* - cookie_functions.js - */
// https://wiki.serpro/portal_javascripts/cookie_functions.js?original=1
...
/* - livesearch.js - */
// https://wiki.serpro/portal_javascripts/livesearch.js?original=1
...
/* - fullscreenmode.js - */
// https://wiki.serpro/portal_javascripts/fullscreenmode.js?original=1
...
/* - select_all.js - */
// https://wiki.serpro/portal_javascripts/select_all.js?original=1
...
/* - dropdown.js - */
// https://wiki.serpro/portal_javascripts/dropdown.js?original=1
...
/* - dragdropreorder.js - */
// https://wiki.serpro/portal_javascripts/dragdropreorder.js?original=1
var ploneDnDReorder={}
...
// https://wiki.serpro/portal_javascripts/mark_special_links.js?original=1
...
// https://wiki.serpro/portal_javascripts/collapsiblesections.js?original=1
...
// https://wiki.serpro/portal_javascripts/highlightsearchterms.js?original=1
...
/* - se-highlight.js - */
// https://wiki.serpro/portal_javascripts/se-highlight.js?original=1
...
// https://wiki.serpro/portal_javascripts/first_input_focus.js?original=1
...
// https://wiki.serpro/portal_javascripts/folder_contents_filter.js?original=1
...
// https://wiki.serpro/portal_javascripts/folder_contents_hideAddItems.js?original=1
...
/* - styleswitcher.js - */
// https://wiki.serpro/portal_javascripts/styleswitcher.js?original=1
function setActiveStyleSheet(title,reset){if(!W3CDOM){return false};var i,a,main;for(i=0;(a=document.getElementsByTagName("link")[i]);i++){if(a.getAttribute("rel").indexOf("style")!=-1&&a.getAttribute("title")){a.disabled=true;if(a.getAttribute("title")==title){a.disabled=false}}}
if(reset==1){createCookie("wstyle",title,365)}};
function setStyle(){var style=readCookie("wstyle");if(style!=null){setActiveStyleSheet(style,0)}};registerPloneFunction(setStyle);

/* - table_sorter.js - */
// https://wiki.serpro/portal_javascripts/table_sorter.js?original=1
...
// https://wiki.serpro/portal_javascripts/calendar_formfield.js?original=1
...
/* - calendarpopup.js - */
// https://wiki.serpro/portal_javascripts/calendarpopup.js?original=1
function showDay(date){document.getElementById('day'+date).style.visibility='visible';return true}
function hideDay(date){document.getElementById('day'+date).style.visibility='hidden';return true}


/* - ie5fixes.js - */
// https://wiki.serpro/portal_javascripts/ie5fixes.js?original=1
...
/* - formUnload.js - */
// https://wiki.serpro/portal_javascripts/formUnload.js?original=1
...
/* - sarissa.js - */
// https://wiki.serpro/portal_javascripts/sarissa.js?original=1
...
/* - login.js - */
// https://wiki.serpro/portal_javascripts/login.js?original=1
...
// https://wiki.serpro/portal_javascripts/formsubmithelpers.js?original=1
