...
function featurefade(_7dc){
if(is.docom){
if(done){
done=false;
if(_7dc!=0){
hele["subhover"+_7dc].style.visibility="visible";
hele["mout"].style.visibility="visible";
if(fx!=0){
hele["feature"+fx].style.zIndex=10;
hele["subhover"+fx].style.visibility="hidden";
}
hele["feature"+_7dc].style.zIndex=20;
hele["feature"+_7dc].style.visibility="visible";
fc=fx;
fx=_7dc;
setTimeout("fadein();",1);
}else{
